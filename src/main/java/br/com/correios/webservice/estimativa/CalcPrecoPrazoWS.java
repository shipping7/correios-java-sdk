 ...
 *
 */
@WebServiceClient(name = "CalcPrecoPrazoWS", targetNamespace = "http://tempuri.org/", wsdlLocation = "classpath:wsdl/CalcPrecoPrazo.wsdl")
    ...
    extends Service
{
    ...
    static {
        CALCPRECOPRAZOWS_WSDL_LOCATION = CalcPrecoPrazoWS.class.getClassLoader().getResource("wsdl/CalcPrecoPrazo.wsdl");
    }
